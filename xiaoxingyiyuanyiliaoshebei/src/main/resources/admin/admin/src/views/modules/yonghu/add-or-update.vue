               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="职员名称" prop="yonghuName">
                       <el-input v-model="ruleForm.yonghuName"
                                 placeholder="职员名称" clearable  :readonly="ro.yonghuName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="职员手机号" prop="yonghuPhone">
                       <el-input v-model="ruleForm.yonghuPhone"
                                 placeholder="职员手机号" clearable  :readonly="ro.yonghuPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="职员身份证号" prop="yonghuIdNumber">
                       <el-input v-model="ruleForm.yonghuIdNumber"
                                 placeholder="职员身份证号" clearable  :readonly="ro.yonghuIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="职员邮箱" prop="yonghuEmail">
                       <el-input v-model="ruleForm.yonghuEmail"
                                 placeholder="职员邮箱" clearable  :readonly="ro.yonghuEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yonghuPhone: [
                              {  required: true, message: '职员手机号不能为空', trigger: 'blur' },
                   ...
                   yonghuIdNumber: [
                              { required: true, message: '职员身份证号不能为空', trigger: 'blur' },
                   ...
                   yonghuPhoto: [
                              { required: true, message: '职员头像不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
                   ...
                   yonghuEmail: [
                              { required: true, message: '职员邮箱不能为空', trigger: 'blur' },
