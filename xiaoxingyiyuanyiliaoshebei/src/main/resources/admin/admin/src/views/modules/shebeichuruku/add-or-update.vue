    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="出入库类型" prop="shebeichurukuTypes">
                        <el-select v-model="ruleForm.shebeichurukuTypes" :disabled="ro.shebeichurukuTypes" placeholder="请选择出入库类型">
                            <el-option
                                v-for="(item,index) in shebeichurukuTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        ...
                        <el-input v-model="ruleForm.shebeichurukuValue"
                            placeholder="出入库类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="出入库数量" prop="shebeichurukuNumber">
                       <el-input v-model="ruleForm.shebeichurukuNumber"
                                 placeholder="出入库数量" clearable  :readonly="ro.shebeichurukuNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="出入库数量" prop="shebeichurukuNumber">
                           <el-input v-model="ruleForm.shebeichurukuNumber"
                                     placeholder="出入库数量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="shebeichurukuText">
                        <el-input type="textarea"  :readonly="ro.shebeichurukuText" v-model="ruleForm.shebeichurukuText" placeholder="备注"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.shebeichurukuYesnoTypes" label="申请状态" prop="shebeichurukuYesnoTypes">
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`shebeichuruku/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
